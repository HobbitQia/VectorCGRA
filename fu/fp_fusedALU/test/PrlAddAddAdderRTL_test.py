...
from ..PrlAddAddAdderRTL    import PrlAddAddAdderRTL
...
class TestHarness( Component ):
  ...
  def construct( s, FunctionUnit, DataType, PredicateType, CtrlType,
                 ...
                 src1_msgs, src2_msgs, src3_msgs, src_const, src_predicate,
                 ctrl_msgs, sink_msgs ):
...
def test_add_add_adder():
  FU            = PrlAddAddAdderRTL
  ...
  src_in2       = [ f2b(1, 1), f2b(3, 1),  f2b(3, 1), f2b(3, 1), f2b(0, 1) ]
  src_in3       = [ f2b(1, 1), f2b(2, 1),  f2b(0, 1), f2b(0, 1), f2b(0, 1) ]
  src_predicate = [ PredicateType(1, 1), PredicateType(1, 0), PredicateType(1, 1) , PredicateType(1, 0), PredicateType(1, 1)]
  src_const     = [ f2b(3, 0), f2b(5, 1), f2b(2, 1), f2b(1, 0), f2b(1, 1) ]
  sink_out      = [ f2b(5, 1), f2b(10, 0), f2b(10, 1), f2b(9, 0), f2b(6, 1) ]
  src_opt       = [ CtrlType( OPT_FADD_FADD_FADD, b1( 1 ), pickRegister ),
                    CtrlType( OPT_FADD_FADD_FADD, b1( 1 ), pickRegister ),
                    CtrlType( OPT_FADD_FADD_FADD, b1( 1 ), pickRegister ),
                    CtrlType( OPT_FADD_FADD,      b1( 1 ), pickRegister ),
                    CtrlType( OPT_FADD,           b1( 1 ), pickRegister )]
  th = TestHarness( FU, DataType, PredicateType, CtrlType,
                    num_inports, num_outports, data_mem_size,
                    src_in0, src_in1, src_in2, src_in3, src_const, src_predicate,
                    src_opt, sink_out )
  run_sim( th )
