...
from ..PrlPhiAddAdder    import PrlPhiAddAdder
...
def test_phi_add_adder():
  ...
  src_in0       = [ f2b(1, 1), f2b(2, 1),  f2b(4, 1)]
  src_in1       = [ f2b(2, 1), f2b(3, 1),  f2b(3, 1)]
  src_in2       = [ f2b(1, 1), f2b(3, 1),  f2b(0, 1)]
  src_in3       = [ f2b(1, 1), f2b(0, 1),  f2b(0, 1)]
  src_const     = [ f2b(3, 0), f2b(5, 1), f2b(2, 1) ]
  src_predicate = [ PredicateType(1, 1), PredicateType(1, 0), PredicateType(1, 1) ]
  sink_out      = [ f2b(3, 1), f2b(5, 0), f2b(4, 1)]
  src_opt       = [ CtrlType( OPT_PHI_FADD_FADD, b1( 1 ), pickRegister ),
                    CtrlType( OPT_PHI_FADD,      b1( 1 ), pickRegister ),
