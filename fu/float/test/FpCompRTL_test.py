...
FpCompRTL_test.py
==========================================================================
Test cases for floating point compare unit.
...
from ..FpCompRTL                   import FpCompRTL
...
#   dut = FpCompRTL( DataType, PredicateType, ConfigType, num_inports,
...
def test_comp_basic():
  ...
  FuInType      = mk_bits( clog2( num_inports + 1 ) )
  pickRegister  = [ FuInType( x+1 ) for x in range( num_inports ) ]
  src_in0       = [ f2b(1.1, 1), f2b(-1.1, 1), f2b(-1.1, 1), f2b(-1.1, 1), f2b(-1.1, 1), f2b(1.1, 1) ]
  src_in1       = [ f2b(1.1, 1), f2b(-2.1, 1), f2b(-1.1, 1), f2b(-2.1, 1), f2b(-1.1, 1), f2b(1.1, 0) ]
  src_predicate = [ PredicateType(1, 0), PredicateType(1, 0), PredicateType(1, 0), 
                    PredicateType(1, 0), PredicateType(1, 0), PredicateType(1, 1) ]
  src_const     = [ f2b(0.0, 0), f2b(0.0, 0), f2b(0.0, 0), f2b(0.0, 0), f2b(0.0, 0), f2b(1.1, 0) ]
  sink_out      = [ DataType(1, 0), DataType(0, 0), DataType(1, 0),
                    DataType(1, 0), DataType(1, 0), DataType(1, 1) ]
  src_opt       = [ ConfigType( OPT_EQ,       b1( 1 ), pickRegister ),
                    ...
                    ConfigType( OPT_EQ_CONST, b1( 1 ), pickRegister )]
