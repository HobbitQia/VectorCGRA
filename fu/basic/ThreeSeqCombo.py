...
#    s.Fu1.recv_opt.msg //= s.recv_opt.msg
    ...
    tmp = RecvIfcRTL( DataType )
    tmp2 = RecvIfcRTL( DataType )

    s.Fu0.recv_const //= s.recv_const
    # s.Fu1.recv_const //= tmp
    # s.Fu2.recv_const //= tmp2
...
#                          s.recv_in[2].en and s.recv_opt.en
      ...
      s.recv_predicate.rdy     @= s.Fu0.recv_predicate.rdy & \
                                  s.Fu1.recv_predicate.rdy & s.Fu2.recv_predicate.rdy
      ...
      s.Fu2.recv_in_count[1] @= s.recv_in_count[3]
